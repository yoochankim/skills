---
name: md-meeting-notes
description: |
  Transform meeting transcripts (MD files) into structured summaries.
...
Best results with Google Meet transcripts generated by Gemini, but compatible with any MD transcript that includes speaker names and timestamps.
